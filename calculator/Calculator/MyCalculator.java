    ...
    public void actionPerformed(ActionEvent ev) {
        ...
        if (tempText.equals("+/-")) {
            if (cl.displayLabel.getText().equals("0")) {
                return; // Do nothing if display is zero
        ...
        if (cl.setClear || cl.displayLabel.getText().endsWith(" ")) {
...
class MyOperatorButton extends Button implements ActionListener {
    ...
    public void actionPerformed(ActionEvent ev) {
        ...
        cl.displayLabel.setText(cl.displayLabel.getText() + " " + opText + " ");

        cl.setClear = true;
        double temp = Double.parseDouble(cl.displayLabel.getText().split(" ")[0]);
 ...
 *
 *  *i) No coding done for "+/-" button. ii) Menubar is not included. iii)Not
 * for Scientific calculation iv)Some of the computation may lead to unexpected
